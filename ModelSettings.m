...
sigma_x=0.6*lambda/2; % this determines g. to obtain the relation between g and sigma_x, use 
...
z1=sum(dz(1:N_diffuser-N_residue));%total thickness of the sampleum
